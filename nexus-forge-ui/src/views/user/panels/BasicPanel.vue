            ...
            <div class="form-grid">
                ...
                <div class="form-control">
                    <div class="handle-input">
                        ...
                        <input id="handle" class="handle-main" type="text" value="@linwan" autocomplete="username" />
                    </div>
                ...
                <div class="form-control">
                    <textarea id="bio" maxlength="160">设计研究员 · 关注人机交互与教育科技。 启明科技用户体验小组。</textarea>
                    <p class="form-help"><span>{{ bioLen }}</span> / 160</p>
                </div>
